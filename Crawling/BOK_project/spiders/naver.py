...
class CrawlingScrapy(scrapy.Spider):
    ...
    def parse_dir_contents(self, response):
        ...
        item['news_date'] = response.css('#contents > section.center1080.position_r > section.aside_left > div.article_news > div.news_titles > div > div > ul > li:nth-child(1) > p:nth-child(1)').get()
        item['news_dir'] = strp
